## Getting Started with Refactored Maskformer

This document provides a brief intro of the usage of Refactored Maskformer.
...
We provide a script `train_net.py`, that is made to train all the configs provided in Refactored Maskformer.
